...
//   const handleFileClick = async (filename, commitId) => {
//     if (fileLoading) return;
//     if (activeFile && activeFile.filename === filename && activeFile.commitId === commitId) {
//       setActiveFile(null);
//       setFileContent("");
//       setCommitMessage("");
//       return;
...
//     setFileContent("");
//     setCommitMessage("");
//     setActiveFile({ filename, commitId });
...
//                 onClick={() => handleFileClick(fileObj.originalName, fileObj.commitId)}
//               >
//                 {fileObj.originalName} <span className="text-xs text-gray-400 ml-2">({fileObj.commitId.slice(0, 6)})</span>
//               </li>
//             ))}
//           </ul>
//         ) : (
...
//         {activeFile && (
//           <div className="mt-6 bg-black/70 border border-white/20 p-4 rounded-xl max-h-[500px] overflow-auto">
